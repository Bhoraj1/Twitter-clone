...
// api for LikeOrDislikes Tweet

export const LikeOrDislikes = async (req,res) =>{
    try {
...
//controller for All tweet
export const GetAllTweet = async(req,res) => {
    try {
        //we need loggedInUser tweet + following user tweet
        const id = req.params.id;
        const loggedInUser = await User.findById(id);

        const loggedInUserTweet = await Tweet.find({userId:id});//loggedInUserTweet
