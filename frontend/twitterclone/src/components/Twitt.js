...
const Twitt = ({ tweet }) => {
  ...
  return (
    <div className="border-b border-grary-200">
      <div>
        <div className="flex p-4">
          ...
          <div className="ml-2 w-full">
            <div className="flex items-center">
              <h1 className=" flex text-bold">{tweet?.userDetails[0]?.name}</h1>
            ...
            <div className="flex justify-between ml-3">
              ...
              <div className="flex items-center">
                <div onClick ={() => bookMarkHandler(user?._id)} className="p-2 hover:bg-green-200 rounded-full cursor-pointer">
